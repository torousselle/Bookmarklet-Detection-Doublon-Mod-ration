...
Cette version ne contient que la partie modération du script Bookmarklet-duplicate-detection-HAL disponible ici https://github.com/Amiantedeluxe/Bookmarklet-duplicate-detection-HAL
